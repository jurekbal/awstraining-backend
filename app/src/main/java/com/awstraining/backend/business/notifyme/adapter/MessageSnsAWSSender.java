...
public class MessageSnsAWSSender implements MessageSender {
    ...
    @Autowired
    public MessageSnsAWSSender(@Value("${notification.topicarn}") String snsTopic, AmazonSNS amazonSNS) {
    ...
    public void send(String text) {
        ...
        LOGGER.info("Message published successfully to topic: {} id={}", snsTopic, publishResult.getMessageId());
    }
}
